...
BUILD_DIR="${ROOT}/build/integration/netns-tcp-tun"
...
if [[ "$(id -u)" != "0" ]]; then
  echo "SKIP: raw TCP/TUN netns integration requires root or CAP_NET_ADMIN"
  exit 0
fi
...
echo "start tapx-core connector"
