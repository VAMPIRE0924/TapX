...
return view.extend({
	...
	render: function(data) {
		...
		return E('div', { 'class': 'tapx-page' }, [ tapx.styles(), E('section', {}, [
			...
			E('div', { 'class': 'tapx-form-group tapx-runtime-group' }, [ E('h3', {}, tr('runtime')), E('div', { 'class': 'tapx-service-list' }, [ tapx.serviceCard(tapx.tr('core'), 'core', tapx.CORE_INIT, data[3].code === 0, state.coreAutostart, 'tapx-core-autostart', state.initialized), tapx.serviceCard(tapx.tr('panel'), 'panel', tapx.PANEL_INIT, data[2].code === 0, state.panelAutostart, 'tapx-panel-autostart', state.initialized) ]) ]),
